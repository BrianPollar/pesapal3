 ...
 *
 * The class takes a configuration object of type `Iconfig`
 * in the constructor, which defines the necessary settings
 *  for the PesaPal integration, such as the environment, consumer key, consumer secret, IPN URL, and callback URL.
 *
 * The `run()` method is used to initialize the PesaPal
 * payment gateway by registering the IPN endpoint
 * and retrieving the IPN endpoints. It returns the
 * instance of the `PesaPalController` class, which can be used to interact with the PesaPal API.
 */
